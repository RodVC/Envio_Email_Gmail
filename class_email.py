...
class Emailer:
    ...
    def anexar_imagens(self,lista_imagens,caminho_imagem):
        #CONFIGURAR O ANEXO DE IMAGENS
        caminho_sistema = os.getcwd()
        os.chdir(caminho_imagem)
        ...
        os.chdir(caminho_sistema)

    def anexar_arquivos_variados(self,lista_arquivos,caminho_arquivo):
